...
namespace SystGest.ViewModels
{
    public class LoginViewModel : ViewModelBase
    {
        ...
        {
            IsBusy = true;
            Views.LoginPage.CurrentEffectMode = Views.LoginPage.EffectMode.Disabled;
            ...
            Views.LoginPage.CurrentEffectMode = Views.LoginPage.EffectMode.Foreground;
            IsBusy = false;
        }
        ...
        {
            //NavigationService.Navigate(typeof(ShellViewModel).FullName, typeof(Views.DashBoardPage));
            NavigationService.Navigate(typeof(ShellViewModel).FullName, _activationState);
        }
